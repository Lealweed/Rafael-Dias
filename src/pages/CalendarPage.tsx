      ...
      {linkedLead && (
        ...
        >
          <div className="flex items-center gap-5">
            ...
            <div>
              <p className="text-[13px] font-bold uppercase tracking-[0.2em] text-emerald-400">Agendamento vinculado</p>
                ...
                <div className="grid grid-cols-1 gap-4 pt-3 border-t border-white/5">
                  {selectedEvent.location && (
                    <div className="flex gap-4">
                      ...
                      <div>
                        <p className="text-[13px] uppercase font-bold tracking-[0.2em] text-white/30">Localização</p>
                  ...
                  {selectedEvent.description && (
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        <p className="text-[13px] uppercase font-bold tracking-[0.2em] text-white/30">Observações Clínicas</p>
          ...
          <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex items-center justify-end gap-4 pt-4">
                <PremiumButton variant="ghost" onClick={() => setFormOpen(false)} className="h-10 px-5 text-[13px]">
                  Cancelar
                </PremiumButton>
